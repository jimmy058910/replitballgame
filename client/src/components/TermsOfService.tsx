  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh]">
        <DialogHeader>
          <DialogTitle>Terms of Service and End-User License Agreement</DialogTitle>
          <DialogDescription>
            Last Updated: July 2nd, 2025
          </DialogDescription>
        </DialogHeader>
...
export function TermsAcceptance({ accepted, onAcceptanceChange }: TermsAcceptanceProps) {
  return (
    <div className="flex items-start space-x-2">
      ...
      />
      <label htmlFor="terms-acceptance" className="text-sm text-gray-600 dark:text-gray-400">
        By creating this account, you acknowledge that you have fully read, understood, and agree to be bound by this{" "}
        <TermsOfService>
          <button
            type="button"

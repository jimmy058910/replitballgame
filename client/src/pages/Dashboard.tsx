    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          {/* Competition Hub Tile */}
          {(seasonalCycle as any) && (
            <div 
              className="mb-6 cursor-pointer transition-transform hover:scale-105"
              onClick={() => window.location.href = '/competition'}
            >
              <img 
                src="@assets/image_1751080761123.png" 
                alt="Competition Hub - Season Status"

...
/**
 * WORKING SCHEDULE RESET
 * Resets games for Days 8-14 back to SCHEDULED status for development testing
 */

async function resetSchedule() {
  console.log('🔧 [SCHEDULE RESET] Starting schedule reset for Days 8-14...');
  ...
  try {
    ...
    console.log('✅ [SCHEDULE RESET] Database connected');
    
    // Get current season (no isActive field, just get the latest)
    ...
    console.log('🎮 [SCHEDULE RESET] Day 8 games will be re-simulated with proper scoring (15-30 points)');
    console.log('📅 [SCHEDULE RESET] Days 9-14 games are now scheduled for future dates');

...
router.get("/mvp/:playerId", requireAuth, asyncHandler(async (req, res) => {
...
router.get("/season/:playerId", requireAuth, asyncHandler(async (req, res) => {
  const { playerId } = req.params;
...
router.get("/player/:playerId", requireAuth, asyncHandler(async (req, res) => {
  const { playerId } = req.params;
...
// Get team awards
router.get("/team/:teamId", requireAuth, asyncHandler(async (req, res) => {
...
router.get("/team/:teamId/history", requireAuth, asyncHandler(async (req, res) => {
  const { teamId } = req.params;
...
router.post("/mvp/:matchId", requireAuth, requirePermission(Permission.MANAGE_MATCHES), asyncHandler(async (req, res) => {
...
router.post("/season/:seasonId/calculate", requireAuth, requirePermission(Permission.MANAGE_SEASONS), asyncHandler(async (req, res) => {
...
router.post("/team/:teamId/history", requireAuth, requirePermission(Permission.MANAGE_SEASONS), asyncHandler(async (req, res) => {
  const { teamId } = req.params;

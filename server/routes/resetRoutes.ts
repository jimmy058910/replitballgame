...
router.post('/reset-and-schedule', requireAuth, async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    if (deletedTeam) {
      ...
      console.log(`✅ Converted DELETED_AI_TEAM → ${newTeamName} (maintaining 8 teams in Division 7 Alpha)`);
    } else {
      console.log(`✅ DELETED_AI_TEAM not found - already converted`);
    }
    ...
    console.log(`✅ Generated ${scheduleResult.matchesGenerated} matches across ${scheduleResult.schedulesCreated} leagues`);
